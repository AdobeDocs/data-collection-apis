...
The `bufferStart` endpoint lets you track the quality and consistency of content playback based on the visitor's connection or media availability. Call this endpoint whenever the media player enters a buffering state. See [Media Edge API implementation examples](../../getting-started/media-edge-examples.md) for more examples calling this endpoint. See the [Buffer start event](https://experienceleague.adobe.com/docs/media-analytics/using/implementation/events/playback/buffer-start) in the Streaming Media services documentation for additional details.
